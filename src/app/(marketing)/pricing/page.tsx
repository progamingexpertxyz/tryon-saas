...
export default async function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 pt-16 sm:pt-24 pb-8 sm:pb-12 text-center">
        <h1 className="text-3xl sm:text-5xl font-extrabold mb-4">Simple pricing</h1>
